...
export function VideoTable({ videos, onPinVideo, pinnedVideoIds = [], channelTitle = "Channel" }: VideoTableProps) {
  ...
  return (
    <section>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mb-6 md:mb-10">
        <h3 className="text-2xl md:text-3xl font-black tracking-tighter text-white" style={{ fontFamily: '"Manrope", sans-serif' }}>
          Video Leaderboard
        </h3>
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1 md:gap-2 bg-[#0f131e]/50 px-2 md:px-4 py-2 md:py-2.5 rounded-full border border-white/5 hover:border-white/10 hover:bg-[#0f131e]/70 transition-all shadow-2xl text-xs md:text-sm"
            >
              <span className="hidden sm:inline text-[9px] md:text-[10px] font-black text-[#a7aab9] uppercase tracking-[0.2em]">Sort:</span>
              <span className="text-[9px] md:text-[11px] font-black text-primary line-clamp-1">{sortLabel}</span>
