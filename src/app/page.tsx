  ...
  return (
    <>
      ...
      <main className="flex-1 pt-20 pb-32 px-12 max-w-[1400px] mx-auto w-full">
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-40 gap-8 bg-surface-container/20 rounded-[3rem] border border-white/5 shadow-2x-strong w-full">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-black tracking-tighter text-white mb-2" style={{ fontFamily: '"Manrope", sans-serif' }}>Crunching Pulse Metrics...</h3>
